...
Route::get('/articulos', 'App\Http\Controllers\ArticuloController@index');//mostrar todos los registreos
Route::post('/articulos', 'App\Http\Controllers\ArticuloController@store');//crear un regstro
